<template>
   <div>
       ...
       <el-dialog :visible.sync="amend_dialog" title="修改数据" width="40%">
           <el-form :model="form">
               <el-form-item label="固废产量">
                   <el-input v-model="form.garbage" auto-complete="off"></el-input>
               </el-form-item>
           </el-form>
       ...
       <el-dialog :visible.sync="delete_dialog" title="删除数据" width="30%">
        ...
        <el-dialog :visible.sync="add_dialog" title="添加数据" width="40%">
           <el-form :model="add_form">
               ...
               <el-form-item label="固废产量">
                   <el-input v-model="add_form.garbage" auto-complete="off"></el-input>
               </el-form-item>
           </el-form>
            <div slot="footer" class="dialog-footer">
