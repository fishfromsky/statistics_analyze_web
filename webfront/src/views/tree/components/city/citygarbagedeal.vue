    ...
    methods: {
        ...
        DownLoad:function(){
            import('@/vendor/Export2Excel').then(excel => {
                const tHeader = ['year', 'collect_factory_num', 'factory_num_total', 'landFill', 'incineration', 'compost', 'else_num']
                const filterVal = ['year', 'collect_factory_num', 'factory_num_total', 'landFill', 'incineration', 'compost', 'else_num']
