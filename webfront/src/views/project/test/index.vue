<template>
    <div class="dashboard-container">
        ...
        <el-row :gutter="20" style="margin-top: 20px">
            <el-col :xs="24" :sm="24" :lg="16">
                <div class="main-step-header">
                    <el-select v-model="selectdata" placeholder="选择实验数据" style="margin-left: 20px">
                        <el-option v-for="item in tableData" :key="item.index" :label="item.name" :value="item.index"></el-option>
                    </el-select>
                    <el-button v-if="selectdata!=null" type="primary" @click="ColSelect" style="margin-left: 10px">参数选择</el-button>
                </div>
            ...
            <el-col :xs="24" :sm="24" :lg="8">
                <div class="table-box">
                    ...
                    :on-success="handleSuccess">
                        ...
                        <div slot="tip" class="el-upload__tip">上传数据文件，仅限excel文件</div>
                    </el-upload>
                    ...
                    <el-table :data="tableData" v-loading="table_loading" border style="margin-top: 20px">
                        <el-table-column label="日期" width="150" prop="time"></el-table-column>
        ...
        <el-dialog :before-close="handleClose" :visible.sync="note_dialog" title="提示信息">
            <span>请从编辑算法页面点击"开始实验"按钮进入本页面！</span>
            <div slot="footer">
                <el-button type="primary" @click="handleClose">确定</el-button>
            </div>
        </el-dialog>
        <el-dialog title="参数选择" :visible.sync="col_dialog" custom-class="col_dialog">
            <div class="col_dialog">
                <span>选择需要进行关联分析的特征</span>
                <el-checkbox-group v-model="checkList" style="margin-top: 20px;margin-bottom: 20px">
                    <el-checkbox v-for="item in select_cols" :label="item" :key="item"></el-checkbox>
                </el-checkbox-group>
                <span>选择关联分析参考数据</span>
                <el-radio-group v-model="reference_col" style="margin-top: 20px;margin-bottom: 20px">
                    <el-radio v-for="item in select_cols" :label="item" :key="item"></el-radio>
                </el-radio-group>
                <span>选取相关性前多少个特征作为预测数据</span>
                <el-input type="number" v-model="relative_max" placeholder="请输入特征数" style="width: 25%; margin-top: 20px"></el-input>
            </div>
