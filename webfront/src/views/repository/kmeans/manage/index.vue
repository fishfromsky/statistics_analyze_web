  ...
  <div class="dashboard-container">
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="24" :lg="8">
        <div class="table-box">
          <div class="box-title">
            <span class="box-title-span">KMEANS实验数据上传</span>
          </div>
          <el-upload
            class="upload-demo"
            action="http://101.133.238.216:8000/api/uploadkmeansfile"
            :file-list="fileList"
...
import { getkmeansfilelist, deletemodelfile } from '@/api/model'
