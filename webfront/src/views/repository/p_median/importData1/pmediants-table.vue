<template>
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.sub_names" placeholder="所属街镇" style="width: 100px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="所属街镇" width="300.0px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.sub_names }}</span>
        </template>
      </el-table-column>
      <el-table-column label="产量权重因子" width="200.0px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.weight_percentage }}</span>
        </template>
      </el-table-column>
      <el-table-column label="经度" width="200.0px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.lng }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="所属区" width="200.0px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="150px" style="width: 500px; margin-left:100px;">
        ...
        <el-form-item label="所属街镇">
          <el-input v-model="temp.sub_names" type="忽略" placeholder="nan" />
        </el-form-item>
        <el-form-item label="产量权重因子">
          <el-input v-model="temp.weight_percentage" type="number" placeholder="输入数字" />
        </el-form-item>
        ...
        <el-form-item label="所属区">
          <el-input v-model="temp.district" type="忽略" placeholder="nan" />
        </el-form-item>
