...
var _earcut = require("../../util/earcut");
...
var _trianglesSortMixin = require("../../util/geometry/trianglesSortMixin");

var _LabelsBuilder = require("./LabelsBuilder");

var _lines3DGlsl = require("../../util/shader/lines3D.glsl.js");

var _visual = require("../../util/visual");

var vec3 = _glmatrix.default.vec3;

_graphicGL.default.Shader.import(_lines3DGlsl.default);

function Geo3DBuilder(api) {
  this.rootNode = new _graphicGL.default.Node(); // Cache triangulation result

  this._triangulationResults = {};
  this._shadersMap = _graphicGL.default.COMMON_SHADERS.reduce(function (obj, shaderName) {
    obj[shaderName] = _graphicGL.default.createShader('ecgl.' + shaderName);
    return obj;
  }, {});
  this._linesShader = _graphicGL.default.createShader('ecgl.meshLines3D');
  var groundMaterials = {};

  _graphicGL.default.COMMON_SHADERS.forEach(function (shading) {
    groundMaterials[shading] = new _graphicGL.default.Material({
      shader: _graphicGL.default.createShader('ecgl.' + shading)
    });
  });

  this._groundMaterials = groundMaterials;
  this._groundMesh = new _graphicGL.default.Mesh({
    geometry: new _graphicGL.default.PlaneGeometry({
      dynamic: true
    }),
    castShadow: false,
    renderNormal: true,
  ...
  this._labelsBuilder = new _LabelsBuilder.default(512, 512, api); // Give a large render order.
...
Geo3DBuilder.prototype = {
  ...
  _initMeshes: function () {
    ...
    function createPolygonMesh() {
      var mesh = new _graphicGL.default.Mesh({
        name: 'Polygon',
        material: new _graphicGL.default.Material({
          shader: self._shadersMap.lambert
        }),
        geometry: new _graphicGL.default.Geometry({
          sortTriangles: true,
          dynamic: true
        }),
      ...
      Object.assign(mesh.geometry, _trianglesSortMixin.default);
      return mesh;
    }
  ...
  _prepareMesh: function (componentModel, shader, api, start, end) {
    ...
    _graphicGL.default.setMaterialFromModel(shader.__shading, polygonMesh.material, componentModel, api);
  ...
  _updateRegionMesh: function (componentModel, api, start, end) {
    ...
    for (var dataIndex = start; dataIndex < end; dataIndex++) {
      ...
      var color = _retrieve.default.firstNotNull((0, _visual.getItemVisualColor)(data, dataIndex), itemStyleModel.get('color'), '#fff');
      ...
      var borderColorArr = _graphicGL.default.parseColor(itemStyleModel.get('borderColor'));
      ...
      var regionHeight = _retrieve.default.firstNotNull(regionModel.get('height', true), componentModel.get('regionHeight'));
    ...
    polygonMesh.frontFace = this.extrudeY ? _graphicGL.default.Mesh.CCW : _graphicGL.default.Mesh.CW; // Update tangents
  ...
  _updateDebugWireframe: function (componentModel) {
    ...
    if (debugWireframeModel.get('show')) {
      ...
      var width = _retrieve.default.firstNotNull(debugWireframeModel.get('lineStyle.width'), 1); // TODO  Will cause highlight wrong
  ...
  _updateGroundPlane: function (componentModel, geo3D, api) {
    ...
    _graphicGL.default.setMaterialFromModel(shading, material, groundModel, api);
    ...
    this._groundMesh.material.set('color', _graphicGL.default.parseColor(groundModel.get('color')));
  ...
  _triangulation: function (componentModel, start, end) {
    ...
    for (var idx = start; idx < end; idx++) {
      ...
      for (var i = 0; i < polygonCoords.length; i++) {
        ...
        var triangles = (0, _earcut.default)(points, holes);
  ...
  highlight: function (dataIndex) {
    ...
    var emphasisOpacity = _retrieve.default.firstNotNull(emphasisItemStyleModel.get('opacity'), (0, _visual.getItemVisualOpacity)(data, dataIndex), 1);
  ...
  downplay: function (dataIndex) {
    ...
    var color = _retrieve.default.firstNotNull((0, _visual.getItemVisualColor)(data, dataIndex), data.getItemModel(dataIndex).get(['itemStyle', 'color']), '#fff');
