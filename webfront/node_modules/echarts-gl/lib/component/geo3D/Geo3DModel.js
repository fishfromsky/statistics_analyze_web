...
var _componentViewControlMixin = require("../common/componentViewControlMixin");
...
var _componentShadingMixin = require("../common/componentShadingMixin");
...
echarts.util.merge(Geo3DModel.prototype, _geo3DModelMixin.default);
echarts.util.merge(Geo3DModel.prototype, _componentViewControlMixin.default);
echarts.util.merge(Geo3DModel.prototype, _componentPostEffectMixin.default);
echarts.util.merge(Geo3DModel.prototype, _componentLightMixin.default);
echarts.util.merge(Geo3DModel.prototype, _componentShadingMixin.default);
