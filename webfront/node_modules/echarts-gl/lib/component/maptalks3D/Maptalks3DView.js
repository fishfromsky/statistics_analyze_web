...
var _Maptalks3DLayer = require("./Maptalks3DLayer");

var _SceneHelper = require("../common/SceneHelper");

var _graphicGL = require("../../util/graphicGL");

var _displayShadowGlsl = require("../../util/shader/displayShadow.glsl.js");

_graphicGL.default.Shader.import(_displayShadowGlsl.default);
...
var _default = echarts.extendComponentView({
    ...
    this._groundMesh = new _graphicGL.default.Mesh({
      ...
      material: new _graphicGL.default.Material({
        shader: new _graphicGL.default.Shader({
          vertex: _graphicGL.default.Shader.source('ecgl.displayShadow.vertex'),
          fragment: _graphicGL.default.Shader.source('ecgl.displayShadow.fragment')
        }),
        depthMask: false
      }),
      // Render first
  ...
  _initMaptalksLayer: function (mapbox3DModel, api) {
    var zr = api.getZr();
    this._zrLayer = new _Maptalks3DLayer.default('maptalks3D', zr, mapbox3DModel.get('center'), mapbox3DModel.get('zoom'));
  ...
  _updateGroundMesh: function () {
    if (this._maptalks3DModel) {
      ...
      var plane = new _graphicGL.default.Plane(new _graphicGL.default.Vector3(0, 0, 1), 0);
      var ray1 = coordSys.viewGL.camera.castRay(new _graphicGL.default.Vector2(-1, -1));
      var ray2 = coordSys.viewGL.camera.castRay(new _graphicGL.default.Vector2(1, 1));
