...
var _Grid3DFace = require("./Grid3DFace");

var _Grid3DAxis = require("./Grid3DAxis");
...
var firstNotNull = _retrieve.default.firstNotNull;
...
var _default = echarts.extendComponentView({
  ...
  init: function (ecModel, api) {
    ...
    var DIMS = ['x', 'y', 'z'];
    var quadsMaterial = new _graphicGL.default.Material({
      // transparent: true,
      shader: _graphicGL.default.createShader('ecgl.color'),
      depthMask: false,
      transparent: true
    });
    var linesMaterial = new _graphicGL.default.Material({
      // transparent: true,
      shader: _graphicGL.default.createShader('ecgl.meshLines3D'),
      depthMask: false,
      transparent: true
    });
    ...
    this._axisPointerLineMesh = new _graphicGL.default.Mesh({
    ...
    this._axisPointerLabelsSurface = new _ZRTextureAtlasSurface.default({
      width: 128,
      height: 128,
      devicePixelRatio: dpr
    });
    this._axisPointerLabelsMesh = new _LabelsMesh.default({
      ignorePicking: true,
      renderOrder: 4,
      castShadow: false
    });
  ...
  _updateAxisPointerOnMousePosition: function (e) {
    ...
    var ray = viewGL.castRay(e.offsetX, e.offsetY, new _graphicGL.default.Ray());
  ...
  _updateFaceVisibility: function () {
    ...
    var viewSpacePos = new _graphicGL.default.Vector3();
    camera.update();
  ...
  _updateAxisLabelAlign: function () {
    ...
    var coords = [new _graphicGL.default.Vector4(), new _graphicGL.default.Vector4()];
    var center = new _graphicGL.default.Vector4();
  ...
  _updateAxisPointer: function (data) {
    ...
    function ifShowAxisPointer(axis) {
      return _retrieve.default.firstNotNull(axis.model.get('axisPointer.show'), axisPointerParentModel.get('show'));
    }
    ...
    function getAxisColorAndLineWidth(axis) {
      ...
      var color = _graphicGL.default.parseColor(lineStyleModel.get('color'));
