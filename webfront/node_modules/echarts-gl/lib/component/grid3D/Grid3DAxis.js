...
function Grid3DAxis(dim, linesMaterial) {
  ...
  var axisLabelsMesh = new _LabelsMesh.default();
  axisLabelsMesh.material.depthMask = false;
  var rootNode = new _graphicGL.default.Node();
...
Grid3DAxis.prototype.update = function (grid3DModel, axisLabelSurface, api) {
  ...
  if (axisLineModel.get('show')) {
    ...
    var color = _graphicGL.default.parseColor(axisLineColor);
  ...
  if (axisTickModel.get('show')) {
    ...
    var lineColor = _graphicGL.default.parseColor(firstNotNull(lineStyleModel.get('color'), axisLineColor));
  ...
  if (axisLabelModel.get('show')) {
    ...
    for (var i = 0; i < labels.length; i++) {
      ...
      var textEl = new echarts.graphic.Text({
        style: (0, _labelStyle.createTextStyle)(itemTextStyleModel, {
          text: formattedLabel,
  ...
  if (axisModel.get('name')) {
    ...
    var textEl = new echarts.graphic.Text({
      style: (0, _labelStyle.createTextStyle)(nameTextStyleModel, {
