...
var _Quads = require("../../util/geometry/Quads");
...
function Grid3DFace(faceInfo, linesMaterial, quadsMaterial) {
  ...
  var quadsMesh = new _graphicGL.default.Mesh({
    geometry: new _Quads.default(),
  ...
  this.plane = new _graphicGL.default.Plane();
  ...
  axes.forEach(function (axis, idx) {
    ...
    if (splitLineModel.get('show')) {
      ...
      for (var i = 0; i < ticksCoords.length; i++) {
        ...
        var lineColor = _graphicGL.default.parseColor(lineColors[count % lineColors.length]);
  ...
  axes.forEach(function (axis, idx) {
    ...
    if (splitAreaModel.get('show')) {
      ...
      for (var i = 0; i < ticksCoords.length; i++) {
        ...
        var color = _graphicGL.default.parseColor(colors[count % colors.length]);
