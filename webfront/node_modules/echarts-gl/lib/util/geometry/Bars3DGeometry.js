...
var _trianglesSortMixin = require("./trianglesSortMixin");
...
var mat3 = _glmatrix.default.mat3;
/**
 * @constructor
...
var BarsGeometry = _Geometry.default.extend(function () {
  return {
    attributes: {
      ...
      prevNormal: new _Geometry.default.Attribute('prevNormal', 'float', 3)
    },
    dynamic: true,
    enableNormal: false,
    bevelSize: 1,
...
echarts.util.defaults(BarsGeometry.prototype, _dynamicConvertMixin.default);
echarts.util.defaults(BarsGeometry.prototype, _trianglesSortMixin.default);
