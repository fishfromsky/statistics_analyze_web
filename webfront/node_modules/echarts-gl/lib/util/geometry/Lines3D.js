 ...
 */
var vec3 = _glmatrix.default.vec3; // var CURVE_RECURSION_LIMIT = 8;
...
var LinesGeometry = _Geometry.default.extend(function () {
  return {
    segmentScale: 1,
    dynamic: true,
    ...
    attributes: {
      ...
      positionPrev: new _Geometry.default.Attribute('positionPrev', 'float', 3),
      positionNext: new _Geometry.default.Attribute('positionNext', 'float', 3),
      prevPositionPrev: new _Geometry.default.Attribute('prevPositionPrev', 'float', 3),
      prevPosition: new _Geometry.default.Attribute('prevPosition', 'float', 3),
      prevPositionNext: new _Geometry.default.Attribute('prevPositionNext', 'float', 3),
      offset: new _Geometry.default.Attribute('offset', 'float', 1),
...
echarts.util.defaults(LinesGeometry.prototype, _dynamicConvertMixin.default);
