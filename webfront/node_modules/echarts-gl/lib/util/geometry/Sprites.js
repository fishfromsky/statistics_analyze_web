...
var SpritesGeometry = _Geometry.default.extend(function () {
  return {
    attributes: {
      position: new _Geometry.default.Attribute('position', 'float', 3, 'POSITION'),
      texcoord: new _Geometry.default.Attribute('texcoord', 'float', 2, 'TEXCOORD_0'),
      offset: new _Geometry.default.Attribute('offset', 'float', 2),
...
echarts.util.defaults(SpritesGeometry.prototype, _dynamicConvertMixin.default);
