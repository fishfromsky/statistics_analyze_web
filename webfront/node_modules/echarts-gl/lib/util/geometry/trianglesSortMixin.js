...
var _ProgressiveQuickSort = require("../ProgressiveQuickSort");
...
var _default = {
  ...
  _simpleSort: function (useNativeQuickSort) {
    ...
    if (useNativeQuickSort) {
      ...
      _ProgressiveQuickSort.default.sort(sortedTriangleIndices, compare, 0, sortedTriangleIndices.length - 1);
    }
  },
  _progressiveQuickSort: function (frame) {
    var faceZList = this._triangleZList;
    var sortedTriangleIndices = this._sortedTriangleIndices;
    this._quickSort = this._quickSort || new _ProgressiveQuickSort.default();
