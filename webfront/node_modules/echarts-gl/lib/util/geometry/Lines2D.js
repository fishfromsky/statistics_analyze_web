 ...
 */
var vec2 = _glmatrix.default.vec2; // var CURVE_RECURSION_LIMIT = 8;
...
var LinesGeometry = _Geometry.default.extend(function () {
  return {
    ...
    useNativeLine: true,
    attributes: {
      position: new _Geometry.default.Attribute('position', 'float', 2, 'POSITION'),
      normal: new _Geometry.default.Attribute('normal', 'float', 2),
