...
var _Base = require("claygl/src/core/Base");
...
var OrbitControl = _Base.default.extend(function () {
  return {
    /**
    ...
    _mouseX: 0,
    _mouseY: 0,
    _rotateVelocity: new _Vector.default(),
    _panVelocity: new _Vector.default(),
    _distance: 500,
    _zoomSpeed: 0,
    _stillTimeout: 0,
    _animators: []
