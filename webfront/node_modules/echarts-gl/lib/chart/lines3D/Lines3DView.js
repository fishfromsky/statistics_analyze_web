...
var _TrailMesh = require("./TrailMesh2");
...
var _default = echarts.extendChartView({
  ...
  render: function (seriesModel, ecModel, api) {
    ...
    this._linesMesh.material.blend = this._trailMesh.material.blend = seriesModel.get('blendMode') === 'lighter' ? _graphicGL.default.additiveBlend : null;
  },
  ...
  _updateLines: function (seriesModel, ecModel, api) {
    ...
    data.each(function (idx) {
      ...
      colorArr = _graphicGL.default.parseColor(color, colorArr);
      colorArr[3] *= opacity;
