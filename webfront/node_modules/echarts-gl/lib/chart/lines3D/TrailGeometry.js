...
var CurveTrailGeometry = _Geometry.default.derive(function () {
  return {
    attributes: {
      uv: new _Geometry.default.Attribute('offset', 'float', 2),
      currT: new _Geometry.default.Attribute('offset', 'float', 1),
      start: new _Geometry.default.Attribute('offset', 'float', 1),
      prevT: new _Geometry.default.Attribute('offset', 'float', 1),
      nextT: new _Geometry.default.Attribute('offset', 'float', 1),
