...
var _default = echarts.extendChartView({
  ...
  render: function (seriesModel, ecModel, api) {
    ...
    if (!this._line3DMesh) {
      this._line3DMesh = new _graphicGL.default.Mesh({
  ...
  _doRender: function (seriesModel, api) {
    ...
    lineMesh.geometry.addPolyline(points, vertexColors, _retrieve.default.firstNotNull(seriesModel.get('lineStyle.width'), 1));
    ...
    if (debugWireframeModel.get('show')) {
      ...
      lineMesh.material.set('wireframeLineColor', _graphicGL.default.parseColor(debugWireframeModel.get('lineStyle.color') || 'rgba(0,0,0,0.5)'));
      lineMesh.material.set('wireframeLineWidth', _retrieve.default.firstNotNull(debugWireframeModel.get('lineStyle.width'), 1));
    } else {
      lineMesh.material.set('both', 'WIREFRAME_TRIANGLE');
    }
  ...
  _updateAnimation: function (seriesModel) {
    _graphicGL.default.updateVertexAnimation([['prevPosition', 'position'], ['prevPositionPrev', 'positionPrev'], ['prevPositionNext', 'positionNext']], this._prevLine3DMesh, this._line3DMesh, seriesModel);
  },
  ...
  _updateNDCPosition: function () {
    ...
    _Matrix.default.multiply(worldViewProjection, camera.projectionMatrix, camera.viewMatrix);
  ...
  _pick: function (x, y, renderer, camera, renderable, out) {
    ...
    if (dataIndex >= 0) {
      var i3 = dataIndex * 3;
      var point = new _Vector.default(this._points[i3], this._points[i3 + 1], this._points[i3 + 2]);
      out.push({
        dataIndex: dataIndex,
        point: point,
