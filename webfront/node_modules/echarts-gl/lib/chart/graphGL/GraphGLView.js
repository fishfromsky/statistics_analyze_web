...
var _ForceAtlas2GPU = require("./ForceAtlas2GPU");

var _ForceAtlas = require("./ForceAtlas2");

var _requestAnimationFrame = require("zrender/lib/animation/requestAnimationFrame");

var _glmatrix = require("claygl/src/dep/glmatrix");

var _visual = require("../../util/visual");

var _Roam2DControl = require("../../util/Roam2DControl");

var _PointsBuilder = require("../common/PointsBuilder");

var _lines2DGlsl = require("../../util/shader/lines2D.glsl.js");

var vec2 = _glmatrix.default.vec2;

_graphicGL.default.Shader.import(_lines2DGlsl.default);
...
echarts.extendChartView({
  ...
  init: function (ecModel, api) {
    ...
    this._pointsBuilder = new _PointsBuilder.default(true, api); // Mesh used during force directed layout.

    this._forceEdgesMesh = new _graphicGL.default.Mesh({
      material: new _graphicGL.default.Material({
        shader: _graphicGL.default.createShader('ecgl.forceAtlas2.edges'),
        transparent: true,
        depthMask: false,
        depthTest: false
      }),
      ...
      geometry: new _graphicGL.default.Geometry({
        attributes: {
          node: new _graphicGL.default.Geometry.Attribute('node', 'float', 2),
    ...
    this._edgesMesh = new _graphicGL.default.Mesh({
      material: new _graphicGL.default.Material({
        shader: _graphicGL.default.createShader('ecgl.meshLines2D'),
        transparent: true,
        depthMask: false,
        depthTest: false
      }),
    ...
    this._layoutId = 0;
    this._control = new _Roam2DControl.default({
      zr: api.getZr(),
      viewGL: this.viewGL
    });
  ...
  render: function (seriesModel, ecModel, api) {
    ...
    if (!(this._forceLayoutInstance instanceof _ForceAtlas2GPU.default)) {
    ...
    this._control.setZoom(_retrieve.default.firstNotNull(seriesModel.get('zoom'), 1));
  ...
  _updateForceEdgesGeometry: function (edges, seriesModel) {
    ...
    edgeData.each(function (idx) {
      ...
      var color = (0, _visual.getItemVisualColor)(edgeData, edge.dataIndex);

      var colorArr = _graphicGL.default.parseColor(color);

      colorArr[3] *= _retrieve.default.firstNotNull((0, _visual.getItemVisualOpacity)(edgeData, edge.dataIndex), 1);
  ...
  _updateMeshLinesGeometry: function () {
    ...
    edgeData.each(function (idx) {
      ...
      var lineWidth = _retrieve.default.firstNotNull(itemModel.get(lineWidthQuery), 1) * this._api.getDevicePixelRatio();
  ...
  _initLayout: function (seriesModel, ecModel, api) {
    ...
    if (layout === 'forceAtlas2') {
      ...
      var edgeWeightRange = _retrieve.default.firstNotNull(layoutModel.get('edgeWeight'), 1.0);

      var nodeWeightRange = _retrieve.default.firstNotNull(layoutModel.get('nodeWeight'), 1.0);
      ...
      if (!layoutInstance) {
        ...
        if (this._forceLayoutInstance) {
          if (isGPU && !(this._forceLayoutInstance instanceof _ForceAtlas2GPU.default) || !isGPU && !(this._forceLayoutInstance instanceof _ForceAtlas.default)) {
            // Mark to dispose
            this._forceLayoutInstanceToDispose = this._forceLayoutInstance;
          }
        }

        layoutInstance = this._forceLayoutInstance = isGPU ? new _ForceAtlas2GPU.default() : new _ForceAtlas.default();
      }
  ...
  _highlightEdge: function (dataIndex) {
    ...
    var emphasisColor = _graphicGL.default.parseColor(itemModel.get('emphasis.lineStyle.color') || itemModel.get('lineStyle.color'));

    var emphasisOpacity = _retrieve.default.firstNotNull(itemModel.get('emphasis.lineStyle.opacity'), itemModel.get('lineStyle.opacity'), 1);
