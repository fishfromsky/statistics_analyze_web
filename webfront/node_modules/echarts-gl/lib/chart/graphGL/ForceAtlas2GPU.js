...
var _forceAtlas2Glsl = require("./forceAtlas2.glsl.js");

_graphicGL.default.Shader.import(_forceAtlas2Glsl.default);
...
function ForceAtlas2GPU(options) {
  ...
  this._positionSourceTex = new _graphicGL.default.Texture2D(textureOpt);
  this._positionSourceTex.flipY = false;
  this._positionTex = new _graphicGL.default.Texture2D(textureOpt);
  this._positionPrevTex = new _graphicGL.default.Texture2D(textureOpt);
  this._forceTex = new _graphicGL.default.Texture2D(textureOpt);
  this._forcePrevTex = new _graphicGL.default.Texture2D(textureOpt);
  this._weightedSumTex = new _graphicGL.default.Texture2D(textureOpt);
  this._weightedSumTex.width = this._weightedSumTex.height = 1;
  this._globalSpeedTex = new _graphicGL.default.Texture2D(textureOpt);
  this._globalSpeedPrevTex = new _graphicGL.default.Texture2D(textureOpt);
  this._globalSpeedTex.width = this._globalSpeedTex.height = 1;
  this._globalSpeedPrevTex.width = this._globalSpeedPrevTex.height = 1;
  this._nodeRepulsionPass = new _Pass.default({
    fragment: _graphicGL.default.Shader.source('ecgl.forceAtlas2.updateNodeRepulsion')
  });
  this._positionPass = new _Pass.default({
    fragment: _graphicGL.default.Shader.source('ecgl.forceAtlas2.updatePosition')
  });
  this._globalSpeedPass = new _Pass.default({
    fragment: _graphicGL.default.Shader.source('ecgl.forceAtlas2.calcGlobalSpeed')
  });
  this._copyPass = new _Pass.default({
    fragment: _graphicGL.default.Shader.source('clay.compositor.output')
  });
  ...
  this._edgeForceMesh = new _graphicGL.default.Mesh({
    geometry: new _graphicGL.default.Geometry({
      attributes: {
        node1: new _graphicGL.default.Geometry.Attribute('node1', 'float', 2),
        node2: new _graphicGL.default.Geometry.Attribute('node2', 'float', 2),
        weight: new _graphicGL.default.Geometry.Attribute('weight', 'float', 1)
      },
      dynamic: true,
      mainAttribute: 'node1'
    }),
    material: new _graphicGL.default.Material({
      transparent: true,
      shader: _graphicGL.default.createShader('ecgl.forceAtlas2.updateEdgeAttraction'),
      blend: additiveBlend,
      depthMask: false,
      depthText: false
    }),
  ...
  this._weightedSumMesh = new _graphicGL.default.Mesh({
    geometry: new _graphicGL.default.Geometry({
      attributes: {
    ...
    material: new _graphicGL.default.Material({
      transparent: true,
      shader: _graphicGL.default.createShader('ecgl.forceAtlas2.calcWeightedSum'),
      blend: additiveBlend,
      depthMask: false,
      depthText: false
    }),
  ...
  this._dummyCamera = new _graphicGL.default.OrthographicCamera({
    left: -1,
    right: 1,
    top: 1,
    bottom: -1,
