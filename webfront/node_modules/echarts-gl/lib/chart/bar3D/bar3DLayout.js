...
var _cartesian3DLayout = require("./cartesian3DLayout");

var _evaluateBarSparseness = require("./evaluateBarSparseness");
...
function globeLayout(seriesModel, coordSys) {
  ...
  if (barSize == null) {
    ...
    var fillRatio = (0, _evaluateBarSparseness.default)(data, dims[0], dims[1]);
  ...
  data.setLayout('orient', _Vector.default.UP.array);
}
...
function mapService3DLayout(seriesModel, coordSys) {
  ...
  if (barSize == null) {
    ...
    var fillRatio = (0, _evaluateBarSparseness.default)(data, dimLng, dimLat); // PENDING, data density
...
echarts.registerLayout(function (ecModel, api) {
  ecModel.eachSeriesByType('bar3D', function (seriesModel) {
    ...
    if (coordSysType === 'globe') {
      ...
      (0, _cartesian3DLayout.default)(seriesModel, coordSys);
