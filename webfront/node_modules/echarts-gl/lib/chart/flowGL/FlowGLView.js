...
var _VectorFieldParticleSurface = require("./VectorFieldParticleSurface");
...
echarts.extendChartView({
  ...
  init: function (ecModel, api) {
    ...
    this._particleSurface = new _VectorFieldParticleSurface.default();
    var planeMesh = new _graphicGL.default.Mesh({
      ...
      material: new _graphicGL.default.Material({
        shader: new _graphicGL.default.Shader({
          vertex: _graphicGL.default.Shader.source('ecgl.color.vertex'),
          fragment: _graphicGL.default.Shader.source('ecgl.color.fragment')
        }),
  ...
  render: function (seriesModel, ecModel, api) {
    ...
    var particleDensity = _retrieve.default.firstNotNull(seriesModel.get('particleDensity'), 128);
    ...
    var color = _graphicGL.default.parseColor(itemStyleModel.get('color'));

    color[3] *= _retrieve.default.firstNotNull(itemStyleModel.get('opacity'), 1);
  ...
  _updateGradientTexture: function (visualMeta, magExtent) {
    ...
    this._gradientTexture = this._gradientTexture || new _graphicGL.default.Texture2D({
