...
var _RayPicking = require("claygl/src/picking/RayPicking");
...
var LayerGL = function (id, zr) {
  ...
  this.views = [];
  this._picking = new _RayPicking.default({
...
LayerGL.prototype.refresh = function (bgColor) {
  this._backgroundColor = bgColor ? _graphicGL.default.parseColor(bgColor) : [0, 0, 0, 0];
    ...
    if (renderable.isRenderable()) {
      ...
      if (material !== prevMaterial) {
        ...
        for (var u = 0; u < textureUniforms.length; u++) {
          ...
          if (val instanceof _Texture.default) {
            updateUsed(val, textureResourceList);
          } else if (val instanceof Array) {
            for (var k = 0; k < val.length; k++) {
              if (val[k] instanceof _Texture.default) {
...
Object.assign(LayerGL.prototype, _notifier.default);
