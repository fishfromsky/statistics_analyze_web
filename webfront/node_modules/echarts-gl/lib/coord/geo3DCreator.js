...
var _Geo3D = require("./geo3D/Geo3D");
...
var idStart = 0;
var geo3DCreator = {
  dimensions: _Geo3D.default.prototype.dimensions,
  create: function (ecModel, api) {
    ...
    function createGeo3D(componentModel, idx) {
      ...
      componentModel.__viewGL = componentModel.__viewGL || new _ViewGL.default();
    ...
    ecModel.eachSeries(function (seriesModel) {
      if (seriesModel.get('coordinateSystem') === 'geo3D') {
        ...
        if (!geo3DModel) {
          throw new Error('geo "' + _retrieve.default.firstNotNull(seriesModel.get('geo3DIndex'), seriesModel.get('geo3DId'), 0) + '" not found');
        }
  ...
  createGeo3D: function (componentModel) {
    ...
    return new _Geo3D.default(name + idStart++, name, mapData && mapData.geoJson, mapData && mapData.specialAreas, componentModel.get('nameMap'));
  }
};
