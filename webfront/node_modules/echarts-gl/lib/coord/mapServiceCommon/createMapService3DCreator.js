...
function _default(serviceComponentType, ServiceCtor, afterCreate) {
  ...
  return {
    ...
    create: function (ecModel, api) {
      ...
      ecModel.eachComponent(serviceComponentType, function (mapService3DModel) {
        ...
        if (!viewGL) {
          viewGL = mapService3DModel.__viewGL = new _ViewGL.default();
          viewGL.setRootNode(new _graphicGL.default.Node());
        }
      ...
      ecModel.eachSeries(function (seriesModel) {
        if (seriesModel.get('coordinateSystem') === serviceComponentType) {
          ...
          if (!mapService3DModel) {
            throw new Error(serviceComponentType + ' "' + _retrieve.default.firstNotNull(seriesModel.get(serviceComponentType + 'Index'), seriesModel.get(serviceComponentType + 'Id'), 0) + '" not found');
          }
