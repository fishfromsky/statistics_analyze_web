...
var globeCreator = {
  dimensions: _Globe.default.prototype.dimensions,
  create: function (ecModel, api) {
    var globeList = [];
    ecModel.eachComponent('globe', function (globeModel) {
      // FIXME
      globeModel.__viewGL = globeModel.__viewGL || new _ViewGL.default();
      var globe = new _Globe.default();
    ...
    ecModel.eachSeries(function (seriesModel) {
      if (seriesModel.get('coordinateSystem') === 'globe') {
        ...
        if (!globeModel) {
          throw new Error('globe "' + _retrieve.default.firstNotNull(seriesModel.get('globe3DIndex'), seriesModel.get('globe3DId'), 0) + '" not found');
        }
    ...
    ecModel.eachComponent('globe', function (globeModel, idx) {
      ...
      if (globeModel.isDisplacementChanged()) {
        if (globeModel.hasDisplacement()) {
          ...
          _graphicGL.default.loadTexture(displacementTextureValue, api, function (texture) {
